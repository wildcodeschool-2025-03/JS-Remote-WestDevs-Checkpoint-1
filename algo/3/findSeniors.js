...
function findSeniors(persons) {
  const devWeb = persons => persons.carriere === 'web dev';
  const experience = persons => persons.experience >= '5';
  const findSeniorsDev = persons.filter(devWeb, experience);
}
console.log(findSeniorsDev);
